    ...
    >
        ...
        <View className="flex-1 items-center justify-center bg-sky-500 bg-opacity-50">
            <View className="bg-white w-11/12 h-96 rounded-md p-5">
                ...
                <Text className="my-1 text-lg "> 1. There is sufficient light or use the flashlight </Text>
                <Text className="my-1 text-lg "> 2. The pest is in focus </Text>
                <Text className="my-1 text-lg "> 3. The pest is in the center of the screen </Text>
                <Text className="my-1 text-lg "> 4. The pest is not obstructed by other objects </Text>
