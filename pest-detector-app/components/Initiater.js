            ...
            <View className="flex-1 justify-center items-center bg-white/50 mt-28">
                <View className="w-80 h-1/2 bg-white rounded-lg shadow-lg border border-sky-500 opacity-100">
                    <View className="flex-1 justify-center items-center">
                        <Text className="text-2xl">{AllowCancel ? "Settings":"Welcome to the App"}</Text>
                        <Text className="mt-5">Please select your country</Text>
                        <View className="w-full flex justify-center items-center">
                        <Picker
                            style={{ height: 100, width: "80%" }}
                            selectedValue={country}
                            onValueChange={(itemValue) => { setCountry(itemValue); ToggleInitiate() ; SetAllowCancel(true) ; storeData("Country",itemValue) }}>
                            <Picker.Item label="Select Country" value="Select Country" disabled />
                            {Countries.map((item, index) => {
                                return (<Picker.Item label={item.name} value={item.name} key={index} />)
                            })}
                        </Picker>
                        {AllowCancel && <Pressable onPress={ToggleInitiate} className="w-20 h-10 bg-red-500 rounded-md flex justify-center items-center">
